...
<head>
    <meta charset="UTF-8">
    <title>PMIS System Login</title>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css">
    <style>
        body { background: url('images/PEZA-background.jpeg') no-repeat center center fixed; background-size: cover; }
        .login-container { max-width: 420px; margin: 80px auto; background: rgba(255,255,255,0.95); padding: 2rem; border-radius: 8px; box-shadow: 0 0 20px rgba(0,0,0,0.25); }
    </style>
</head>
<body>
<div class="login-container">
    <h2 class="text-center">PROCUREMENT MARKET INTELLIGENCE SYSTEM (PMIS)</h2>
    <p class="text-center">Philippine Economic Zone Authority</p>
    <p class="text-center">Security Features:<br>✔ Session login | ✔ Role-based access | ✔ Activity log</p>
    <?php if ($errors): ?>
